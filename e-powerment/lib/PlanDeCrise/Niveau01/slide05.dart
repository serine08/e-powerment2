...
import 'package:e_empowerment/PlanDeCrise/Niveau01/slide06.dart';
    ...
    _controller.addStatusListener((status) {
      if (status == AnimationStatus.completed) {
        Navigator.push(context, MaterialPageRoute(builder: (context) {
          return slide06(); // Make sure to use the correct class name for the next page
        }));
      }
    });
                    ...
                    return Transform.scale(
                      ...
                      child: FractionalTranslation(
                        ...
                        child: const SpeechBubble(
                          text:
                          'Est-ce que tu saurais dire ce qui peut l’aggraver ? Essaie de te souvenir de ta(tes) dernière(s)crise(s) et de ce qui a pu faire empirer la situation. Sélectionne ce qui correspond pour toi aux facteurs aggravants',
