...
import 'package:e_empowerment/PlanDeCrise/Niveau01/slide04.dart';
    ...
    _controller.addStatusListener((status) {
      if (status == AnimationStatus.completed) {
        Navigator.push(context, MaterialPageRoute(builder: (context) {
          return slide04(); // Make sure to use the correct class name for the next page
        }));
      }
    });
                    ...
                    return Transform.scale(
                      ...
                      child: FractionalTranslation(
                        ...
                        child: const SpeechBubble(
                          text:
                          'Est-ce que tu sais ce qui la déclenche ? Essaie de te souvenir de ta(tes) dernière(s)crise(s). Sélectionne ce qui correspond pour toi aux facteurs déclencheurs',
