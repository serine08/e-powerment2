...
class pageNiveau02 extends StatefulWidget {
  const pageNiveau02({Key? key}) : super(key: key);

  @override
  State<pageNiveau02> createState() => _pageNiveau01State();
}

class _pageNiveau01State extends State<pageNiveau02> with TickerProviderStateMixin{
