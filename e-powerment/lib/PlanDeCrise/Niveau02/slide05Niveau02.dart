import 'package:e_empowerment/PlanDeCrise/Niveau02/slide04Niveau02.dart';
import 'package:e_empowerment/PlanDeCrise/Niveau02/slide06Niveau02.dart';
import 'package:flutter/material.dart';


class slide05Niveau02 extends StatefulWidget {
  slide05Niveau02({Key? key}) : super(key: key);

  @override
  State<slide05Niveau02> createState() => _slide05Niveau02State();
}
...
class _slide05Niveau02State extends State<slide05Niveau02> with TickerProviderStateMixin {
  TextEditingController myController = TextEditingController();
  String? buttonText;

  List<String> buttonOptions = [
    'Chez moi',
    'Chez un·e ami·e / une personne proche',
    'Dans ma famille',
    'A la campagne',
    'Dans un parc',
    'Dans la nature',
    ...
    _controller.addStatusListener((status) {
      if (status == AnimationStatus.completed) {
        Navigator.push(context, MaterialPageRoute(builder: (context) {
          return slide06Niveau02(); // Make sure to use the correct class name for the next page
        }));
      }
    });
                    ...
                    return Transform.scale(
                      ...
                      child: FractionalTranslation(
                        ...
                        child: const SpeechBubble(
                          text:
                          'Quels sont les endroits qui peuvent t’aider à traverser une crise ? Essaie de te souvenir deta(tes) dernière(s) crise(s) et sélectionne les lieux où tu te sentais mieux',
