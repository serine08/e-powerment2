...
class slide01Niveau02 extends StatefulWidget {
  slide01Niveau02({Key? key}) : super(key: key);

  @override
  State<slide01Niveau02> createState() => _slide01Niveau02State();
}
...
class _slide01Niveau02State extends State<slide01Niveau02> with TickerProviderStateMixin {
    ...
    _controller.addStatusListener((status) {
      if (status == AnimationStatus.completed) {
        Navigator.push(context, MaterialPageRoute(builder: (context) {
          return MyForm(); // Make sure to use the correct class name for the next page
        }));
      }
    });
                    ...
                    return Transform.scale(
                      ...
                      child: FractionalTranslation(
                        ...
                        child: const SpeechBubble(
                          text:
                          'Souvent, on n’appelle pas en cas de crise car on ne sait pas qui appeler et on a peur dedéranger. Ici, tu peux identifier les personnes (famille, soignant·es, ami·es...) qui pourraient t’aider. Ilest important de leur expliquer ta démarche. Il faut leur demander si elles sont d’accord pourparticiper à ton plan de crise.',
