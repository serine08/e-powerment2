...
class slide03Niveau02 extends StatefulWidget {
  slide03Niveau02({Key? key}) : super(key: key);

  @override
  State<slide03Niveau02> createState() => _slide03Niveau02State();
}
...
class _slide03Niveau02State extends State<slide03Niveau02> with TickerProviderStateMixin {
    ...
    _controller.addStatusListener((status) {
      if (status == AnimationStatus.completed) {
        Navigator.push(context, MaterialPageRoute(builder: (context) {
          return slide04Niveau02(); // Make sure to use the correct class name for the next page
        }));
      }
    });
                    ...
                    return Transform.scale(
                      ...
                      child: FractionalTranslation(
                        ...
                        child: const SpeechBubble(
                          text:
                          'Qu’est-ce qui peut apaiser un moment de crise ? Souviens-toi de ta(tes) dernière(s) crise(s)et de ce qui a pu améliorer la situation. Sélectionne cequi correspond pour toi à des choses quiaident à passer la crise',
