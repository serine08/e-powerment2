...
import 'package:e_empowerment/PlanDeCrise/Niveau03/FinNiveau03.dart';
import 'package:flutter/material.dart';


class slide02Niveau03 extends StatefulWidget {
  const slide02Niveau03({Key? key}) : super(key: key);

  @override
  State<slide02Niveau03> createState() => _slide02Niveau03State();
}

class _slide02Niveau03State extends State<slide02Niveau03> with TickerProviderStateMixin {
    ...
    _controller.addStatusListener((status) {
      if (status == AnimationStatus.completed) {
        Navigator.push(context, MaterialPageRoute(builder: (context) {
          return FinNiveau03(); // Make sure to use the correct class name for the next page
        }));
      }
    });
  }
