...
class ReponsesProlonger3 extends StatelessWidget {
  ReponsesProlonger3({Key? key, required this.value}) : super(key: key);
  final String value;
                    ...
                    child: Stack(
                        children:[
                          ...
                          Align(
                            ...
                            child: RichText(
                              text:  const TextSpan(
                                text: 'Si tu exprimes une limite et qu’elle n’est pas respectée : tu m’en vas, tu te défends, tu quittes la pièce, tu fais une blague mais tu répètes ce que tu viens de dire, etc.',
