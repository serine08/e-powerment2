...
import 'package:e_empowerment/plan%C3%A8te01/Niveau05/rouge/ReponsesProlonger3.dart';
...
class ReponsesProlonger2 extends StatelessWidget {
  ReponsesProlonger2({Key? key, required this.value}) : super(key: key);
  final String value;
                    ...
                    child: Stack(
                        children:[
                          ...
                          Align(
                            ...
                            child: RichText(
                              text:  const TextSpan(
                                text: 'Une réaction instinctive, sans censure aucune : même violente, extravagante, socialement inacceptable',
                            ...
                            child: IconButton(
                              ...
                              onPressed: (){
                                Navigator.push(context, MaterialPageRoute(builder: (context){
                                  ...
                                  return    ReponsesProlonger3(value: value);
                                },),);
