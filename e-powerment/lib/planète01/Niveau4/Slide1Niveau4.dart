...
class Slide1N4 extends StatefulWidget {
  const Slide1N4({Key? key}) : super(key: key);

  @override
  State<Slide1N4> createState() => _Slide1N4State();
}

class _Slide1N4State extends State<Slide1N4> {
